...
따라서 Point cloud값이 확실할 때 이러한 방법들을 사용해야한다. 이 말을 듣고 보니 Lidar SLAM을 할 때는 ICP를 많이 활용하지만, Visual SLAM의 경우 ICP보다는 Bundle Adjustment를 많이 활용하는데 아마 point cloud의 uncertainties 때문이라고 생각이 들었다.  
