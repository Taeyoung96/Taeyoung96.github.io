...
<p align="center"><img src="https://user-images.githubusercontent.com/41863759/127118490-95db2044-f9e6-4c41-abfc-996c277a0bfd.png" width = "500" ></p>  

강의 자료를 통해 알 수 있듯이, Observation function $\{f_i (x)\}_{i=1:n}$ 이라고 주어졌을 때, $z_{1:n}$ 에는 Noise가 존재하고, 최종적으로 $x$의 상태를 추정하는 것이 목표이다.  
