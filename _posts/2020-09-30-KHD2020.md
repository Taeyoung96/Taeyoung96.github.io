...
**모델의 마지막 layer와 Backbone layer의 마지막 layer를 학습 시키는 방법**을 이용하여 가장 성능이 좋은 모델을 찾으려고 노력했다.  
...
Crop도 시도를 했지만, Train image와 Test image가 Scale이 같아서인지  
오히려 Crop을 했을 때에는 성능이 떨어졌다.
